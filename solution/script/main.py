...
if __name__ == '__main__':
    ...
    print('-- there was a DEPOSIT TRANSACTION in amount 40000-15000 = 35000')
    print('at ts:1578648600000 the balance is set 21000') 
    print('-- there was a WITHDRAWAL TRANSACTION in amount 40000-21000 = 19000')
    print('at ts:1578648600000 the balance is set 33000'
